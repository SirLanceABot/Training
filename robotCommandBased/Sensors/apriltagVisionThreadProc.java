...
public void run() {
    ...
    UsbCamera camera = CameraServer.startAutomaticCapture(); // http://10.42.37.2:1181/
    // Set the resolution
    ...
    CvSource outputStream = CameraServer.putVideo("Detected", 640, 480); // http://10.42.37.2:1182/
